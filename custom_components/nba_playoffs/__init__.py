...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Initial sync — ensures game_id is populated before listeners attach
    live_coordinator.update_from_series(series_coordinator.data)

    # Attach listener AFTER initial sync to prevent overwriting with None
    live_coordinator.attach_series_coordinator(series_coordinator)

    # Start live polling only after HA is fully started
