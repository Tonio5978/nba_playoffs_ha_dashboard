...
class NBAPlayoffsConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for NBA Playoffs."""
...
class NBAPlayoffsOptionsFlowHandler(config_entries.OptionsFlow):
    """Handle options for NBA Playoffs."""
...
) -> NBAPlayoffsOptionsFlowHandler:
    return NBAPlayoffsOptionsFlowHandler(config_entry)
